...
@section('content')
    ...
    <form name="form1" action="">
        <div class="row">
            ...
            <div class="col-9">
                <a href="#ajaxModal" class="ajax_add btn btn-sm mycolor1" data-bs-toggle="modal" data-bs-target="#ajaxModal"
                    style="float: right;">추가</a>
            </div>
        </div>
    </form>
    <!-- 사용자 table -->
    <table class="table table-sm table-bordered table-hove mymargin5" id="table_list">
        <tr class="mycolor2">
            <td width="10%">번호</td>
            <td width="80%">구분명</td>
            <td width="10%">삭제</td>
        ...
        @foreach ($list as $row)
            <tr id="rowno{{ $row->id }}">
                <td>{{ $row->id }}</td>
                <td>
                    <a href="#ajaxModal" data-bs-toggle="modal" data-bs-target="#ajaxModal" class="ajax_edit"
                        data-id="{{ $row->id }}" data-name="{{ $row->name }}">{{ $row->name }}</a>
                </td>
                <td>
                    ...
                    <form name="form2" method="post" action="">
                        ...
                        <table class="table table-sm table-borderless mymargin5">
                            <tr>
                                <td width="30%">번호</td>
                                <td width="70%">
                                    <input type="text" name="id" id="data_id" class="form-control form-control-sm"
                                        disabled>
                                </td>
                            </tr>
                            <tr>
